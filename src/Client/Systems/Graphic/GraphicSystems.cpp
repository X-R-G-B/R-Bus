...
namespace Systems {
    ...
    {
        std::vector<std::function<void(std::size_t, std::size_t)>> graphicSystems;
        ...
        graphicSystems.insert(graphicSystems.end(), audioSystems.begin(),
            audioSystems.end());
        graphicSystems.insert(graphicSystems.end(), spriteSystems.begin(),
            spriteSystems.end());
        graphicSystems.insert(graphicSystems.end(), textSystems.begin(),
            textSystems.end());
        graphicSystems.insert(graphicSystems.end(), deathSystems.begin(),
            deathSystems.end());
