...
namespace Nitwork {
    class NitworkServer : public ANitwork {
        public:
            ...
            bool start(int port, int threadNb = DEFAULT_THREAD_NB, int tick = TICKS_PER_SECOND) final;

            bool startNitworkConfig(int port) final;
        ...
        private:
            ...
            boost::asio::ip::udp::endpoint _endpoint; // endpoint of the NitworkServer
